...
class BodyGeneratorUnitTest extends TestUtils {
        ...
        void shouldGenerateJsonObject() throws IOException {
                ...
                String jsonString = generators
                                .getBodyGenerator()
                                .generate(openAPI.getComponents().getSchemas().get("User"));
                String output = "{\"id\":10,\"username\":\"John Doe\",\"firstName\":\"John Doe\",\"lastName\":\"John Doe\","
        ...
        void shouldGenerateFileContents() throws IOException {
                ...
                String fileContents = generators
                                .getBodyGenerator()
                                .generate(
                                                ((Schema<?>) openAPI.getPaths()
        ...
        void shouldHandleRequestBodyRef() throws IOException {
                OpenAPI openAPI = parseResource("PetStore_defn.yaml");
                String requestBody = new RequestModelConverter()
                                .convert(
                                                new OperationModel(
                ...
                String requestBody = new RequestModelConverter()
                                .convert(
                                                new OperationModel(
                                                                ...
                                                                openAPI.getPaths().get("/v3/openapi/headerAll")
                                                                                .getPost(),
                                                                null),
                                                generators)
                                .getBody();
        ...
        void testAllOf() throws IOException {
                ...
                String requestBody = new RequestModelConverter()
                                .convert(
                                                new OperationModel(
                                                                "/pets", openAPI.getPaths().get("/pets").getPatch(),
                                                                null),
                                                generators)
                                .getBody();
                assertEquals(
        ...
        void testAnyOf() throws IOException {
                ...
                String request = new RequestModelConverter()
                                .convert(
                                                new OperationModel(
                                                                "/pets", openAPI.getPaths().get("/pets").getPatch(),
                                                                null),
        ...
        void testNot() throws IOException {
                ...
                String requestType = new RequestModelConverter()
                                .convert(
                                                new OperationModel(
                                                                "/pets", openAPI.getPaths().get("/pets").getPatch(),
                                                                null),
                ...
                String requestAge = new RequestModelConverter()
                                .convert(
                                                new OperationModel(
                                                                "/pets", openAPI.getPaths().get("/pets").getGet(),
                                                                null),
                                                generators)
                                .getBody();
                ...
                String request = new RequestModelConverter()
                                .convert(
                                                new OperationModel(
                                                                ...
                                                                openAPI.getPaths().get("/v3/openapi/mapString")
                                                                                .getPost(),
                                                                null),
                                                generators)
                                .getBody();
                ...
                String request = new RequestModelConverter()
                                .convert(
                                                new OperationModel(
                                                                ...
                                                                openAPI.getPaths().get("/v3/openapi/mapNumber")
                                                                                .getPost(),
                                                                null),
                                                generators)
                                .getBody();
                ...
                String request = new RequestModelConverter()
                                .convert(
                                                new OperationModel(
                                                                ...
                                                                openAPI.getPaths().get("/v3/openapi/mapBoolean")
                                                                                .getPost(),
                                                                null),
                                                generators)
                                .getBody();
                ...
                String request = new RequestModelConverter()
                                .convert(
                                                new OperationModel(
                                                                ...
                                                                openAPI.getPaths().get("/v3/openapi/mapObject")
                                                                                .getPost(),
                                                                null),
                                                generators)
                                .getBody();
                ...
                String request = new RequestModelConverter()
                                .convert(
                                                new OperationModel(
                                                                ...
                                                                openAPI.getPaths().get("/media-type-no-schema")
                                                                                .getPost(),
                                                                null),
                                                generators)
                                .getBody();
        ...
        void shouldNotGenerateContentForApplicationXml() throws IOException {
                ...
                OperationModel operationModel = new OperationModel("/xml", definition.getPaths().get("/xml").getPost(),
                                null);
                // When
