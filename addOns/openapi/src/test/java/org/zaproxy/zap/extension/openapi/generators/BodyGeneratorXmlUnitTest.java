...
class BodyGeneratorXmlUnitTest extends TestUtils {
    ...
    void shouldGenerateXmlWithNamespaceAndPrefix() throws Exception {
        ...
        org.junit.jupiter.api.Assertions.assertEquals("http://example.com/ns", root.getNamespaceURI());
    }
    ...
    void shouldGenerateXmlForBinary() throws Exception {
        ...
        io.swagger.v3.oas.models.media.BinarySchema file = new io.swagger.v3.oas.models.media.BinarySchema();
